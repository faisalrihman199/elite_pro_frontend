...
const TaskDashboard = () => {
    ...
    const projects = [
        ...
        {
            "id": 160,
            "task_name": "Cloud Computing Setup",
            "deadline": "2024-11-30"
        },
        {
            "id": 32,
            "task_name": "Cybersecurity Framework",
            "deadline": "2024-11-20"
        },
        {
            "id": 33,
            "task_name": "React Native App Development",
            "deadline": "2024-12-05"
        },
        {
            "id": 161,
            "task_name": "IoT Platform Design",
            "deadline": "2024-11-25"
        },
        {
            "id": 47,
            "task_name": "Data Analytics Tool",
            "deadline": "2024-12-10"
        },
        {
            "id": 166,
            "task_name": "Machine Learning Model",
            "deadline": "2024-12-12"
        },
        {
            "id": 51,
            "task_name": "Web Development Platform",
            "deadline": "2024-11-28"
        },
        {
            "id": 170,
            "task_name": "Augmented Reality App",
            "deadline": "2024-12-07"
        }
    ];
    ...
    const chartData = [
        { label: "Pending Tasks", value: 50 },
        { label: "Running Tasks", value: 200 },
        { label: "Completed Tasks", value: 220 },
    ];
